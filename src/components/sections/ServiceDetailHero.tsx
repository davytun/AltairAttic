...
export const ServiceDetailHero = ({ service }: Props) => {
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-obsidian">
