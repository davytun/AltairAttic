...
export const Process = () => {
  return (
    <section className="bg-obsidian py-20 md:py-32 border-t border-white/5 relative overflow-hidden">
      <DotBackground
        dotSize={1.3}
        gap={36}
      ...
      <div className="container-luxury relative z-10">
        <div className="mb-20 md:mb-32 space-y-8 text-center md:text-left text-balance">
          ...
          <h2 className="text-huge font-display font-black leading-[0.85] uppercase tracking-tighter">
            Blueprint to <br />{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-white/5 border border-white/5">
          {steps.map((step, i) => (
            ...
            >
              <span className="text-6xl md:text-7xl font-display font-black text-white/5 group-hover:text-obsidian/10 transition-colors uppercase">
                {step.num}
              </span>
              <div className="space-y-6">
                <h3 className="text-xl md:text-2xl font-display uppercase tracking-tight group-hover:text-obsidian transition-colors">
                  {step.title}
                </h3>
                <div className="h-px w-full bg-white/10 group-hover:bg-obsidian/20 transition-colors" />
